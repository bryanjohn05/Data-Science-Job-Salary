...
import { getModelInfo, clearSavedModel } from "@/lib/model-storage"
...
export default function Dashboard() {
  ...
  if (!data || !model) {
    // Show dashboard with placeholder data instead of loading screen
    return (
      <div className="min-h-screen bg-background">
        <div className="container mx-auto p-6">
          <div className="mb-8">
            ...
            <div className="mt-4 text-sm text-muted-foreground">Loading data and initializing model...</div>
          </div>
            ...
            <div className="text-right">
              {modelInfo && (
                <div className="mb-4 p-3 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="text-xs text-green-600">Data: {new Set(data.rawData.map((job) => job.job_title)).size} jobs</div>
                </div>
              )}
              {/* <Button onClick={handleRetrainModel} variant="outline" size="sm" disabled={loading}>
